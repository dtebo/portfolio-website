...
- NOTE: Added Sass property to _header.scss for transition to see what CSS it generates. '@include vendor('transition', 'height #{_duration(transition)} ease-in');' generated the following:
